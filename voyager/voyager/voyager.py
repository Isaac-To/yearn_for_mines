...
class Voyager:
    def __init__(
        ...
        action_agent_model_name: str = "deepseek-v4-pro:cloud",
        action_agent_temperature: float = 0,
        action_agent_task_max_retries: int = 4,
        action_agent_show_chat_log: bool = True,
        action_agent_show_execution_error: bool = True,
        curriculum_agent_model_name: str = "deepseek-v4-pro:cloud",
        curriculum_agent_temperature: float = 0,
        curriculum_agent_qa_model_name: str = "deepseek-v4-pro:cloud",
        curriculum_agent_qa_temperature: float = 0,
        curriculum_agent_warm_up: Dict[str, int] = None,
        curriculum_agent_core_inventory_items: str = r".*_log|.*_planks|stick|crafting_table|furnace"
        r"|cobblestone|dirt|coal|.*_pickaxe|.*_sword|.*_axe",
        curriculum_agent_mode: str = "auto",
        critic_agent_model_name: str = "deepseek-v4-pro:cloud",
        critic_agent_temperature: float = 0,
        critic_agent_mode: str = "auto",
        skill_manager_model_name: str = "deepseek-v4-pro:cloud",
        ...
        # set openai api key (not required when using Ollama Cloud)
        if openai_api_key:
    ...
    def step(self):
        ...
        U.log_llm_call(
            ...
            ckpt_dir=self.curriculum_agent.ckpt_dir,
        )
    ...
    def inference(self, task=None, sub_goals=[], reset_mode="hard", reset_env=True):
        ...
        while self.curriculum_agent.progress < len(sub_goals):
            ...
            try:
                ...
                import traceback
                traceback.print_exc()
                info = {"task": next_task, "success": False}
            self.curriculum_agent.update_exploration_progress(info)
            print(
                f"\033[35mCompleted tasks: {', '.join(self.curriculum_agent.completed_tasks)}\033[0m"
            )
